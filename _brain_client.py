...
All brain_bus_publisher.py files in the ecosystem import from here.
Discovery priority:
  BRAIN_SYNC_PATH env var → ../the-brain/ sibling → ~/the-brain/
Set BRAIN_DB_PATH if brain.db is in a non-standard location (brain_sync.py handles this).
"""
...
def _find_brain_sync():
    ...
    print("[brain_client] brain_sync.py not found. "
          "Set BRAIN_SYNC_PATH (directory containing brain_sync.py).")
    return None
